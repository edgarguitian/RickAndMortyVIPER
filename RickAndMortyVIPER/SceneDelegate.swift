...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene,
        ...
        charactersTab.tabBarItem = UITabBarItem(title: "Characters",
                                                image: UIImage(systemName: "person.3.fill"), tag: 0)
        ...
        locationsTab.tabBarItem = UITabBarItem(title: "Locations",
                                               image: UIImage(systemName: "location.fill"), tag: 1)

        let episodesTab = UINavigationController(rootViewController: episodesListView)
        episodesTab.tabBarItem = UITabBarItem(title: "Episodes",
                                              image: UIImage(systemName: "tv.fill"), tag: 2)
